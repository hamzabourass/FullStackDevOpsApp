...
if [ "$ENVIRONMENT" = "staging" ]; then
  ...
  scp -o StrictHostKeyChecking=no -i "${SSH_PRIVATE_KEY_FILE}" docker-compose.yml ec2-user@ec2-100-25-16-179.compute-1.amazonaws.com:/home/ec2-user/docker-compose.yml
  ssh -o StrictHostKeyChecking=no -i "${SSH_PRIVATE_KEY_FILE}" ec2-user@ec2-100-25-16-179.compute-1.amazonaws.com 'cd /home/ec2-user && docker-compose up -d'
